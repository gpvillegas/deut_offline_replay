...
void replay_deut_scalers(Int_t RunNumber = 0, Int_t MaxEvent = 0, TString ftype="") {
  ...
  */
  ...
  // Define DEF-file+
  TString DefTreeFile="DEF-files/deut_scalers.def";
  ...
  if(ftype.Data()=="shms50k"){
    ...
    DefCutTreeFile="DEF-files/CUTS/deut_scalers_cuts.def";
  }
  ...
  TString TEMPLATE_FileName="TEMPLATES/deut_scalers.template";
