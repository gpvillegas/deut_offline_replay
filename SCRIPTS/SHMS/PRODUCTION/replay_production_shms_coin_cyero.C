void replay_production_shms_coin_cyero (Int_t RunNumber = 0, Int_t MaxEvent = 0, Int_t FirstEvent = 1) {
  ...
  const char* ROOTFileNamePattern = "ROOTfiles/shms50k/shms_coin_replay_production_%d_%d.root";
  ...
  */
  ...
  // Define DEF-file
  analyzer->SetOdefFile("DEF-files/cafe_shms50k.def");
  // Define cuts file
  analyzer->SetCutFile("DEF-files/CUTS/cafe_cuts_shms.def");  // optional
  ...
  //			Form("MON_OUTPUT/replay_shms_coin_production_%d_%d.report", RunNumber, MaxEvent));  // optional
