...
void make_online_plots_mod(int run=0, int evt=0, Bool_t simc_exist=0, TString tgt_type="", TString ana_type="", TString ana_cut="", TString data_file_path="", TString simc_file_path="", Bool_t draw_norm=1)
{
 ...
 //Define SIMC histos ('h'-->hadron arm,  'e'-->electron arm)
  ...
  if(simc_exist) {
    ...
    simc_file->GetObject("quality_plots/H_htar_x_ACCP_CUTS", simc_xtarH);
    simc_file->GetObject("quality_plots/H_htar_y_ACCP_CUTS", simc_ytarH);
    simc_file->GetObject("quality_plots/H_htar_z_ACCP_CUTS", simc_ztarH);
    
    simc_file->GetObject("quality_plots/H_etar_x_ACCP_CUTS", simc_xtarP);
    simc_file->GetObject("quality_plots/H_etar_y_ACCP_CUTS", simc_ytarP);  
    simc_file->GetObject("quality_plots/H_etar_z_ACCP_CUTS", simc_ztarP); 
  ...
  if(simc_exist) {
    ...
    //Get Histogram objects from SIMC rootfile
    simc_file->GetObject("quality_plots/H_eytar_ACCP_CUTS", simc_eytar);
    simc_file->GetObject("quality_plots/H_exptar_ACCP_CUTS", simc_exptar);
    simc_file->GetObject("quality_plots/H_eyptar_ACCP_CUTS", simc_eyptar);
    simc_file->GetObject("quality_plots/H_edelta_ACCP_CUTS", simc_edelta);
    
    simc_file->GetObject("quality_plots/H_hytar_ACCP_CUTS", simc_hytar);
    simc_file->GetObject("quality_plots/H_hxptar_ACCP_CUTS", simc_hxptar);
    simc_file->GetObject("quality_plots/H_hyptar_ACCP_CUTS", simc_hyptar);
    simc_file->GetObject("quality_plots/H_hdelta_ACCP_CUTS", simc_hdelta);
  ...
  //Get Histogram objects from SIMC rootfile
  simc_file->GetObject("quality_plots/H_exfp_ACCP_CUTS", simc_exfp);
  simc_file->GetObject("quality_plots/H_eyfp_ACCP_CUTS", simc_eyfp);
  simc_file->GetObject("quality_plots/H_expfp_ACCP_CUTS", simc_expfp);
  simc_file->GetObject("quality_plots/H_eypfp_ACCP_CUTS", simc_eypfp);

  simc_file->GetObject("quality_plots/H_hxfp_ACCP_CUTS", simc_hxfp);
  simc_file->GetObject("quality_plots/H_hyfp_ACCP_CUTS", simc_hyfp);
  simc_file->GetObject("quality_plots/H_hxpfp_ACCP_CUTS", simc_hxpfp);
  simc_file->GetObject("quality_plots/H_hypfp_ACCP_CUTS", simc_hypfp);
  //Set SIMC Histo Aesthetics
  ...
  //Get Histogram objects from SIMC rootfile
  simc_file->GetObject("quality_plots/H_Q2_ACCP_CUTS", simc_Q2);
  simc_file->GetObject("quality_plots/H_nu_ACCP_CUTS", simc_nu);
  simc_file->GetObject("quality_plots/H_W_ACCP_CUTS", simc_W);
  simc_file->GetObject("quality_plots/H_thq_ACCP_CUTS", simc_thq);

  simc_file->GetObject("quality_plots/H_xbj_ACCP_CUTS", simc_xbj);
  simc_file->GetObject("quality_plots/H_the_ACCP_CUTS", simc_the);
  simc_file->GetObject("quality_plots/H_kf_ACCP_CUTS", simc_kf);
  simc_file->GetObject("quality_plots/H_Em_ACCP_CUTS", simc_Em);
  simc_file->GetObject("quality_plots/H_MM_ACCP_CUTS", simc_MM);

  simc_file->GetObject("quality_plots/H_Pm_ACCP_CUTS", simc_Pm);
  simc_file->GetObject("quality_plots/H_Pf_ACCP_CUTS", simc_Pf);
  simc_file->GetObject("quality_plots/H_thx_ACCP_CUTS", simc_thx);
  simc_file->GetObject("quality_plots/H_q_ACCP_CUTS", simc_q);
  simc_file->GetObject("quality_plots/H_thxq_ACCP_CUTS", simc_thxq);
  simc_file->GetObject("quality_plots/H_thrq_ACCP_CUTS", simc_thrq);

  simc_file->GetObject("quality_plots/H_Pmx_ACCP_CUTS", simc_Pmx);
  simc_file->GetObject("quality_plots/H_Pmy_ACCP_CUTS", simc_Pmy);
  simc_file->GetObject("quality_plots/H_Pmz_ACCP_CUTS", simc_Pmz);
...
if(ana_cut!="heep_singles"){
  ...
  //-----------------PLOT KINEMATICS SIMC/Data comparison---------------
   ...
   //Draw Normalized?
   if(draw_norm){
     if(simc_exist) simc_Q2->DrawNormalized("histE0");
     data_Q2->DrawNormalized("sameshistE0");
   }
   else{
     if(simc_exist) simc_Q2->Draw("histE0");
   ...
   //Draw Normalized?
   if(draw_norm){
     if(simc_exist) simc_nu->DrawNormalized("histE0");
     data_nu->DrawNormalized("sameshistE0");
   }
   else{
     if(simc_exist) simc_nu->Draw("histE0");
   ...
   //Draw Normalized?
   if(draw_norm){
     if(simc_exist) simc_W->DrawNormalized("histE0");
     data_W->DrawNormalized("sameshistE0");
   }
   else{
     if(simc_exist) simc_W->Draw("histE0");
   ...
   //Draw Normalized?
   if(draw_norm){
     if(simc_exist) simc_thq->DrawNormalized("histE0");
     data_thq->DrawNormalized("sameshistE0");
   }
   else{
     if(simc_exist) simc_thq->Draw("histE0");
   ...
   //Draw Normalized?
   if(draw_norm){
     if(simc_exist) simc_xbj->DrawNormalized("histE0");
     data_xbj->DrawNormalized("sameshistE0");
   }
   else{
     if(simc_exist) simc_xbj->Draw("histE0");
   ...
   //Draw Normalized?
   if(draw_norm){
     if(simc_exist) simc_the->DrawNormalized("histE0");
     data_the->DrawNormalized("sameshistE0");
   }
   else{
     if(simc_exist) simc_the->Draw("histE0");
   ...
   if(simc_exist) simc_kf->Draw("histE0");
   data_kf->Draw("sameshistE0");
   //Draw Normalized?
   if(draw_norm){
     if(simc_exist) simc_kf->DrawNormalized("histE0");
   ...
   if(draw_norm){
     if((tgt_type=!"LD2")){
       if(simc_exist) simc_Em->DrawNormalized("histE0");
     }
     ...
     if((tgt_type=!"LD2")){
       if(simc_exist) simc_Em->Draw("histE0");
     }
   ...
   if(draw_norm){
     if((tgt_type=!"LD2") && (ana_cut=="SRC")){
       if(simc_exist) simc_MM->DrawNormalized("histE0");
     }
     data_MM->DrawNormalized("sameshistE0");
   }
   else{
     if((tgt_type=!"LD2") && (ana_cut=="SRC")){
       if(simc_exist) simc_MM->Draw("histE0");
     }
   ...
   //Draw Normalized?
   if(draw_norm){
     if(simc_exist) simc_Pm->DrawNormalized("histE0");
     data_Pm->DrawNormalized("sameshistE0");
   }
   else{
     if(simc_exist) simc_Pm->Draw("histE0");
   ...
   //Draw Normalized?
   if(draw_norm){
     if(simc_exist) simc_Pf->DrawNormalized("histE0");
     data_Pf->DrawNormalized("sameshistE0");
   }
   else{
     if(simc_exist) simc_Pf->Draw("histE0");
   ...
   //Draw Normalized?
   if(draw_norm){
     if(simc_exist) simc_thx->DrawNormalized("histE0");
     data_thx->DrawNormalized("sameshistE0");
   }
   else{
     if(simc_exist) simc_thx->Draw("histE0");
   ...
   //Draw Normalized?
   if(draw_norm){
     if(simc_exist) simc_q->DrawNormalized("histE0");
     data_q->DrawNormalized("sameshistE0");
   }
   else{
     if(simc_exist) simc_q->Draw("histE0");
   ...
   //Draw Normalized?
   if(draw_norm){
     if(simc_exist) simc_thxq->DrawNormalized("histE0");
     data_thxq->DrawNormalized("sameshistE0");
   }
   else{
     if(simc_exist) simc_thxq->Draw("histE0");
   ...
   //Draw Normalized?
   if(draw_norm){
     if(simc_exist) simc_thrq->DrawNormalized("histE0");
     data_thrq->DrawNormalized("sameshistE0");
   }
   else{
     if(simc_exist) simc_thrq->Draw("histE0");
   ...
   //Draw Normalized?
   if(draw_norm){
     if(simc_exist) simc_Pmx->DrawNormalized("histE0");
     data_Pmx->DrawNormalized("sameshistE0");
   }
   else{
     if(simc_exist) simc_Pmx->Draw("histE0");
   ...
   //Draw Normalized?
   if(draw_norm){
     if(simc_exist) simc_Pmy->DrawNormalized("histE0");
     data_Pmy->DrawNormalized("sameshistE0");
   }
   else{
     if(simc_exist) simc_Pmy->Draw("histE0");
   ...
   //Draw Normalized?
   if(draw_norm){
     if(simc_exist) simc_Pmz->DrawNormalized("histE0");
     data_Pmz->DrawNormalized("sameshistE0");
   }
   else{
     if(simc_exist) simc_Pmz->Draw("histE0");
  ...
  //Set Legend
   ...
   //Draw Normalized?
   if(draw_norm){
     if(simc_exist) simc_exfp->DrawNormalized("histE0");
     data_exfp->DrawNormalized("sameshistE0");
   }
   else{
     if(simc_exist) simc_exfp->Draw("histE0");
   ...
   //Draw Normalized?
   if(draw_norm){
     if(simc_exist) simc_eyfp->DrawNormalized("histE0");
     data_eyfp->DrawNormalized("sameshistE0");
   }
   else{
     if(simc_exist) simc_eyfp->Draw("histE0");
   ...
   //Draw Normalized?
   if(draw_norm){
     if(simc_exist) simc_expfp->DrawNormalized("histE0");
     data_expfp->DrawNormalized("sameshistE0");
   }
   else{
     if(simc_exist) simc_expfp->Draw("histE0");
   ...
   //Draw Normalized?
   if(draw_norm){
     if(simc_exist) simc_eypfp->DrawNormalized("histE0");
     data_eypfp->DrawNormalized("sameshistE0");
   }
   else{
     if(simc_exist) simc_eypfp->Draw("histE0");
   ...
   //Draw Normalized?
   if(draw_norm){
     if(simc_exist) simc_hxfp->DrawNormalized("histE0");
     data_hxfp->DrawNormalized("sameshistE0");
   }
   else{
     if(simc_exist) simc_hxfp->Draw("histE0");
   ...
   //Draw Normalized?
   if(draw_norm){
     if(simc_exist) simc_hyfp->DrawNormalized("histE0");
     data_hyfp->DrawNormalized("sameshistE0");
   }
   else{
     if(simc_exist) simc_hyfp->Draw("histE0");
   ...
   //Draw Normalized?
   if(draw_norm){
     if(simc_exist) simc_hxpfp->DrawNormalized("histE0");
     data_hxpfp->DrawNormalized("sameshistE0");
   }
   else{
     if(simc_exist) simc_hxpfp->Draw("histE0");
   ...
   //Draw Normalized?
   if(draw_norm){
     if(simc_exist) simc_hypfp->DrawNormalized("histE0");
     data_hypfp->DrawNormalized("sameshistE0");
   }
   else{
     if(simc_exist) simc_hypfp->Draw("histE0");
   ...
   //Draw Normalized?
   if(draw_norm){
     if(simc_exist) simc_eytar->DrawNormalized("histE0");
     data_eytar->DrawNormalized("sameshistE0");
   }
   else{
     if(simc_exist) simc_eytar->Draw("histE0");
   ...
   //Draw Normalized?
   if(draw_norm){
     if(simc_exist) simc_exptar->DrawNormalized("histE0");
     data_exptar->DrawNormalized("sameshistE0");
   }
   else{
     if(simc_exist) simc_exptar->Draw("histE0");
   ...
   //Draw Normalized?
   if(draw_norm){
     if(simc_exist) simc_eyptar->DrawNormalized("histE0");
     data_eyptar->DrawNormalized("sameshistE0");
   }
   else{
     if(simc_exist) simc_eyptar->Draw("histE0");
   ...
   //Draw Normalized?
   if(draw_norm){
     if(simc_exist) simc_edelta->DrawNormalized("histE0");
     data_edelta->DrawNormalized("sameshistE0");
   }
   else{
     if(simc_exist) simc_edelta->Draw("histE0");
   ...
   //Draw Normalized?
   if(draw_norm){
     if(simc_exist) simc_hytar->DrawNormalized("histE0");
     data_hytar->DrawNormalized("sameshistE0");
   }
   else{
     if(simc_exist) simc_hytar->Draw("histE0");
   ...
   //Draw Normalized?
   if(draw_norm){
     if(simc_exist) simc_hxptar->DrawNormalized("histE0");
     data_hxptar->DrawNormalized("sameshistE0");
   }
   else{
     if(simc_exist) simc_hxptar->Draw("histE0");
   ...
   //Draw Normalized?
   if(draw_norm){
     if(simc_exist) simc_hyptar->DrawNormalized("histE0");
     data_hyptar->DrawNormalized("sameshistE0");
   }
   else{
     if(simc_exist) simc_hyptar->Draw("histE0");
   ...
   //Draw Normalized?
   if(draw_norm){
     if(simc_exist) simc_hdelta->DrawNormalized("histE0");
     data_hdelta->DrawNormalized("sameshistE0");
   }
   else{
     if(simc_exist) simc_hdelta->Draw("histE0");
 ...
 //-----------------PLOT TARGET VERTEX Variables SIMC/Data comparison-----------------------
  ...
  //Set Legend
   ...
   //Draw Normalized?
   if(draw_norm){
     if(simc_exist) simc_xtarH->DrawNormalized("histE0");
     data_xtarH->DrawNormalized("sameshistE0");
   }
   else{
     if(simc_exist) simc_xtarP->Draw("histE0");
   ...
   //Draw Normalized?
   if(draw_norm){
     if(simc_exist) simc_ytarH->DrawNormalized("histE0");
     data_ytarH->DrawNormalized("sameshistE0");
   }
   else{
     if(simc_exist) simc_ytarH->Draw("histE0");
   ...
   //Draw Normalized?
   if(draw_norm){
     if(simc_exist) simc_ztarH->DrawNormalized("histE0");
     data_ztarH->DrawNormalized("sameshistE0");
   }
   else{
     if(simc_exist) simc_ztarH->Draw("histE0");
   ...
   //Draw Normalized?
   if(draw_norm){
     if(simc_exist) simc_xtarP->DrawNormalized("histE0");
   ...
   //Draw Normalized?
   if(draw_norm){
     if(simc_exist) simc_ytarP->DrawNormalized("histE0");
     data_ytarP->DrawNormalized("sameshistE0");
   }
   else{
     if(simc_exist) simc_ytarP->Draw("histE0");
   ...
   //Draw Normalized?
   if(draw_norm){
     if(simc_exist) simc_ztarP->DrawNormalized("histE0");
     data_ztarP->DrawNormalized("sameshistE0");
   }
   else{
     if(simc_exist) simc_ztarP->Draw("histE0");
