...
if os.path.isfile(fname_path):
    ...
    if(query=='y' or query=='Y' or query=='yes' or query=='YES'):
        print('OK, will overwrite run %i in csv file !' % RUNNUM)
        overwrite_flag = True
    elif(query=='n' or query=='N' or query=='no' or query=='NO'):
        print('Will NOT overwrite run %i in csv file !' % RUNNUM)
        overwrite_flag = False
    ...
    if(overwrite_flag):
        ...
        with open(fname_path, "a") as f:
            ...
            for line in reader:
                ...
                #search for RUNNUM, and replace the line when it finds it
