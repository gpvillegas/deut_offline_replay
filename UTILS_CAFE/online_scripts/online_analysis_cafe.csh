...
source "${onlineDir}/cafe_online_replay/setup.csh"

echo "--> changing to replay folder - ${onlineDir}/cafe_online_replay"
cd "${onlineDir}/cafe_online_replay"
...
echo "Run './run_cafe_sample.sh' to run a 100k (default) event sample replay + physics analysis "
echo "Run './run_cafe_prod.sh' to run a full event replay + physics analysis "
echo "HCANA raw data replay output is in: ./ROOTfiles and ./REPORT_OUTPUT"
echo "CaFe physics analysis output is in: ./CAFE_OUTPUT "
echo ""
